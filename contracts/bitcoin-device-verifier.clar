;; Proven Bitcoin Device Verification Contract
;; This contract manages Bitcoin device authentication, verification, and participation tracking
;; for the Proven Bitcoin Device platform, enabling secure device registration, tracking,
;; and validation using blockchain-based cryptographic proofs.
;; Error codes
